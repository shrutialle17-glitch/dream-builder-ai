        ...
        <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-12">
          <div className="w-full max-w-[440px] bg-surface border border-border/60 rounded-3xl shadow-xl shadow-black/10 p-8 md:p-10">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-text-secondary text-sm">Access your investor terminal and insights.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm py-1">
                <label className="flex items-center gap-2 cursor-pointer text-text-secondary hover:text-text-primary transition-colors">
                  <input type="checkbox" className="rounded border-border/50 bg-background/50 text-primary focus:ring-primary focus:ring-offset-background h-4 w-4" />
                  <span>Remember me</span>
                </label>
                <button type="button" className="text-primary hover:text-primary-hover hover:underline font-medium focus:outline-none">
                  Forgot password?
                </button>
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs font-medium">
                <span className="bg-surface px-4 text-text-secondary">Log in with</span>
              </div>
            </div>
